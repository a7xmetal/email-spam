      ...
      >
         <div class="flex items-center px-4 py-2">
            <div class="flex items-center">
               <component
                  :is="
                     isSelected ? CheckboxOutlineIcon : CheckboxBlankOutlineIcon
                  "
               ...
               <router-link :to="`/email/message/${id}`" class="w-full">
                  <div class="flex justify-between items-center">
                     <div class="flex items-center w-full">
                        ...
                        <div
                           class="font-semibold text-sm truncate-from flex justify-center text-red-500"
                           :class="{ hidden: !spam }"
                        >
                           Spam Email
                        </div>
                        <div class="flex items-center justify-between">
                           <div
                              class="mr-1.5 text-sm font-semibold truncate-subject"
                           >
                              {{ subject }}
                           </div>
                           <div
                              class="text-sm text-gray-500 truncate-body pr-2"
                           >
                              - {{ body }}...
                           </div>
                        </div>
...
const { id, from, subject, body, time, spam } = toRefs(props);
